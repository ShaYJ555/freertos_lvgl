...
/* Display. */
#define BOARD_LCD_DC_GPIO     GPIO3 /*! LCD data/command port */
#define BOARD_LCD_DC_GPIO_PIN 4U   /*! LCD data/command pin */

#define BOARD_LCD_RESET_GPIO  GPIO3
#define BOARD_LCD_RESET_GPIO_PIN 7U

#define BOARD_LCD_LED_GPIO  GPIO2
#define BOARD_LCD_LED_GPIO_PIN 31U
